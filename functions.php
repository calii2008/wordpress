...
function config(){
    register_nav_menus(
        array(
            'wp_devs_menu' => 'main_menu',
            'wp_devs_footer_menu' => 'footer_menu'
        )
    );
    $args=array(
        'height' => 225,
...
funcrion wp_devs_widgets_init() {
    register_sidebar(
        array(
            'name' => 'Sidebar',
            'id' => 'sidebar-1',
            'description' => 'Main Sidebar',
            'before_widget' => 'this is the blog sibebar.you can add widgets here',
            'after_widget' => '</div>',
    ...
    register_sidebar(
        array(
            'name' => 'services 1',
            'id' => 'service-1',
            'description' => 'Footer Service area',
